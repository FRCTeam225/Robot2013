...
public class RobotMap {
    public static int LEFT_JS = 1;
    public static int RIGHT_JS = 2;
    public static int OPERATOR_JS = 3;
    ...
    public static int FEEDERHOMESWITCH = 3;
    
    
    public static int TURRETANGLE_A = 5;
    public static int TURRETANGLE_B = 4;
    
    public static int DRIVELOCK_A = 1;
    public static int DRIVELOCK_B = 2;
